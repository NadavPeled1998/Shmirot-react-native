  ...
  return (
    <styleContext.Provider
      value={{
        ...
        inputsContainer: [styles.inputsContainer, {width: dimensions.width / 1.05, maxHeight: dimensions.height/3.25}],
        ...
        nameInput: [styles.nameInput, {height: dimensions.height/20, fontSize: dimensions.height/40, marginHorizontal: dimensions.width/80}],
        ...
        bottomBorder: [styles.bottomBorder, {width: dimensions.width/2.5}],
        boldTitleBorder: [styles.boldTitleBorder, {width: dimensions.width/3.5}],
        savedGroupBorder: [styles.bottomBorder, {width: dimensions}.width/3],
        mainImage: [styles.firstImage, {width: dimensions.width/1.4, 
